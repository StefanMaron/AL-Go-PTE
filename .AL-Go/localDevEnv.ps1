...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/StefanMaron/AL-Go/Actions/20776d8bf1a3d1b6a865602aca97a2160294307c/Github-Helper.psm1' -folder $tmpFolder -notifyAuthenticatedAttempt
$ReadSettingsModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/StefanMaron/AL-Go/Actions/20776d8bf1a3d1b6a865602aca97a2160294307c/.Modules/ReadSettings.psm1' -folder $tmpFolder
$debugLoggingModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/StefanMaron/AL-Go/Actions/20776d8bf1a3d1b6a865602aca97a2160294307c/.Modules/DebugLogHelper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/StefanMaron/AL-Go/Actions/20776d8bf1a3d1b6a865602aca97a2160294307c/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/StefanMaron/AL-Go/Actions/20776d8bf1a3d1b6a865602aca97a2160294307c/.Modules/settings.schema.json' -folder $tmpFolder | Out-Null
DownloadHelperFile -url 'https://raw.githubusercontent.com/StefanMaron/AL-Go/Actions/20776d8bf1a3d1b6a865602aca97a2160294307c/Environment.Packages.proj' -folder $tmpFolder | Out-Null
