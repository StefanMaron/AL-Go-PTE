...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/StefanMaron/AL-Go/Actions/4fd75f161fc8f5dd6a3d4bc1c528975d1b04363a/Github-Helper.psm1' -folder $tmpFolder -notifyAuthenticatedAttempt
$ReadSettingsModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/StefanMaron/AL-Go/Actions/4fd75f161fc8f5dd6a3d4bc1c528975d1b04363a/.Modules/ReadSettings.psm1' -folder $tmpFolder
$debugLoggingModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/StefanMaron/AL-Go/Actions/4fd75f161fc8f5dd6a3d4bc1c528975d1b04363a/.Modules/DebugLogHelper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/StefanMaron/AL-Go/Actions/4fd75f161fc8f5dd6a3d4bc1c528975d1b04363a/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/StefanMaron/AL-Go/Actions/4fd75f161fc8f5dd6a3d4bc1c528975d1b04363a/.Modules/settings.schema.json' -folder $tmpFolder | Out-Null
DownloadHelperFile -url 'https://raw.githubusercontent.com/StefanMaron/AL-Go/Actions/4fd75f161fc8f5dd6a3d4bc1c528975d1b04363a/Environment.Packages.proj' -folder $tmpFolder | Out-Null
